...
export async function getSalt(id) {
  ...
  try {
    let res = await axios.get("/v1/salt", {
      params: query,
...
export async function getArticles(
  ...
  try {
    let res = await axios.get("/v1/articles", {
      params: query,
      withCredentials: true,
    });
    return res.data;
...
export async function countArticles(kind) {
  ...
  try {
    let res = await axios.get("/v1/articles/count", {
      params: query,
      withCredentials: true,
    });
...
export async function tryRegister(id, pw, name) {
  ...
  try {
    let res = await axios.post("/v1/register", reqBody, {
      withCredentials: true,
    });
    return res.data;
  } catch (err) {
...
export async function getArticle(articleId) {
  try {
    let res = await axios.get("/v1/articles/" + articleId, {
      withCredentials: true,
    });
    return res.data;
  } catch (err) {
...
export async function postArticle(article) {
  try {
    let res = await axios.post("/v1/articles/", article, {
      withCredentials: true,
    });
    return res.data;
  } catch (err) {
...
export async function getFileInfo(fileId) {
  try {
    let res = await axios.get("/v1/files/info/" + fileId, {
      withCredentials: true,
    });
    return res.data;
  } catch (err) {
